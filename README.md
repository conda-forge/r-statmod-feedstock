...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-statmod-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-statmod-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-statmod-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-statmod-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-statmod-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-statmod-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-statmod/badges/version.svg)](https://anaconda.org/conda-forge/r-statmod)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-statmod/badges/downloads.svg)](https://anaconda.org/conda-forge/r-statmod)
